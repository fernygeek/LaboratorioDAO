...
<body>
    <main class="page-card">
        ...
        <p class="subtitle">Modifique la informacion del usuario</p>

        <c:if test="${not empty mensaje}">
            <div class="mensaje"><c:out value="${mensaje}" /></div>
        </c:if>

        <form id="formUsuario" action="${pageContext.request.contextPath}/gestionar?ruta=actualizarAdministrador" method="post">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="clave" name="clave" value="<c:out value='${usuario.clave}' />" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select id="perfil" disabled>
                        ...
                        <option value="Empleado" ${usuario.perfil == 'Empleado' ? 'selected' : ''}>Empleado</option>
                    </select>
                    <input type="hidden" name="perfil" value="<c:out value='${usuario.perfil}' />" />
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="idDepartamento" name="idDepartamento">
                            ...
                            <c:forEach var="d" items="${departamentos}">
                                <option value="${d.idDepartamento}" ${usuario.departamento.idDepartamento == d.idDepartamento ? 'selected' : ''}>
    ...
    <script>
        ...
        function actualizarFormulario() {
            ...
            form.action = contexto + '/gestionar?ruta=actualizarAdministrador';
        }
